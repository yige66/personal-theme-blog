...
export default async function MusicPage() {
  ...
  return (
    <main className="subpage" style={{ '--theme': data.site.themeColor, '--accent': data.site.accentColor } as React.CSSProperties}>
      ...
      <PageHero eyebrow="Music" title="星屿电台" description="写作、阅读和编码时的背景歌单。每首歌都带着一个使用场景，作为文章和项目之间的轻量氛围层。" />
      <PageInsightBar items={[{ label: '曲目', value: data.site.music.length, caption: '歌单数量' }, { label: '可播', value: playableTracks.length, caption: '音频地址配置' }, { label: '用途', value: 'Focus', caption: '阅读写作背景' }]} action={{ href: '/console', label: '管理歌单' }} />
