...
export default async function GalleryPage() {
  ...
  return (
    <main className="subpage" style={{ '--theme': data.site.themeColor, '--accent': data.site.accentColor } as React.CSSProperties}>
      ...
      <PageHero eyebrow="Gallery" title="灵境照片墙" description="用于陈列头像、头图、项目截图、生活照片和视觉碎片，图片可以跟随素材库持续替换。" />
      <PageInsightBar items={[{ label: '图片', value: data.site.gallery.length, caption: '相册素材' }, { label: '来源', value: 'Assets', caption: '仓库素材库' }, { label: '展示', value: 'Grid', caption: '响应式照片墙' }]} action={{ href: '/console', label: '管理素材' }} />
