...
export default async function ProjectsPage() {
  ...
  return (
    <main className="subpage" style={{ '--theme': data.site.themeColor, '--accent': data.site.accentColor } as React.CSSProperties}>
      ...
      <PageInsightBar items={[{ label: '项目', value: data.projects.length, caption: '作品矩阵' }, { label: '精选', value: data.projects.filter((project) => project.featured).length, caption: '首页展示' }, { label: '维护', value: 'CMS', caption: '后台可编辑' }]} action={{ href: '/console', label: '管理项目' }} />
      <section className="main-shell project-grid page-grid">
