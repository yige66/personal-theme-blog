...
describe('target-inspired homepage portal', () => {
  ...
  it('implements background layers and day/night transition states', async () => {
    ...
    assert.match(component, /const drawLeafAccumulation[\s\S]*index < 58/);
    assert.match(component, /for \(let index = 0; index < 142; index \+= 1\)/);
    ...
    assert.match(component, /index < 1040/);
    ...
    assert.match(component, /drawSnowAccumulation\(Math\.max\(1, groundLevels\[settle\.to\]\), 0, 0\.94\)/);
    ...
    assert.match(component, /const settledGrowth = Math\.max\(baseGrowth, groundLevels\[settle\.to\]\)/);
    assert.match(component, /drawSpringGround\(settledGrowth \* 0\.8, now, false, 0\)/);
    assert.match(component, /drawPetalAccumulation\(settledGrowth \* 0\.72, now\)/);
    ...
    assert.match(component, /const pileHeight = Math\.min\(118, Math\.max\(56, height \* 0\.092\)\) \* level/);
    ...
    assert.match(component, /index < 118/);
    ...
    assert.match(homeCss, /body \.xh-season-switch\.is-transitioning \.xh-switch-label-stack > strong\.is-current[\s\S]*xh-switch-current-label-fade 1500ms/);
    assert.match(homeCss, /Final badge material polish/);
    assert.match(homeCss, /html body \.xh-theme-switch,[\s\S]*html body \.xh-season-switch[\s\S]*grid-template-rows: 12px 18px 12px/);
    assert.match(homeCss, /html body \.xh-theme-switch,[\s\S]*html body \.xh-season-switch[\s\S]*width: 164px !important/);
    ...
    assert.match(homeCss, /html body \.xh-theme-switch small,[\s\S]*html body \.xh-season-switch small[\s\S]*font-size: 9\.5px !important/);
    assert.match(homeCss, /html body \.xh-theme-switch,[\s\S]*html body \.xh-season-switch,[\s\S]*width: 148px !important/);
    assert.match(homeCss, /html body \.xh-season-switch \.xh-season-switch-kicker,[\s\S]*html body \.xh-season-switch small[\s\S]*display: block !important/);
