...
describe('target-inspired homepage portal', () => {
  ...
  it('implements background layers and day/night transition states', async () => {
    ...
    assert.match(component, /Math\.round\(intensity \/ 2\.75\)/);
    assert.match(component, /const size = 18 \+ \(index % 4\) \* 2/);
    assert.match(component, /--firefly-drift-x/);
    assert.match(component, /--firefly-glow-delay/);
    assert.match(component, /--petal-drift/);
    assert.match(component, /--petal-rotate/);
